<div class="wrap">
	...
	<form method="post">
		<div class="konnichiwa-wrap konnichiwa-form wp-admin">
			...
			<input type="button" value="<?php _e('Cancel', 'konnichiwa')?>" onclick="window.location = 'admin.php?page=konnichiwa_subs&plan_id=<?php echo $_GET['plan_id']?>&ob=<?php echo $_GET['ob']?>&dir=<?php echo $_GET['dir']?>&offset=<?php echo $_GET['offset']?>'" class="button"></p>
